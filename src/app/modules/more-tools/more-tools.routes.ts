...
router.post("/roman-numerals-date-converter", MoreToolsController.convertRomanNumeralsDate);  // ✅
...
router.post("/random-address-generator", MoreToolsController.generateRandomAddress); // ✅ 
...
router.post("/upside-down-text-generator", MoreToolsController.generateUpsideDownText);  // ✅ 
//===================================THIS TOOL ALREADY THERE, NAME BINARY TRANSLATOR==================================
...
router.post("/roman-numeral-converter", MoreToolsController.convertRomanNumeral);   // ✅ 
...
router.post("/probability-calculator", MoreToolsController.calculateProbability);  // ✅ 
