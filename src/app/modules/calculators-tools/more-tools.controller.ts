...
const convertRomanNumeralsDate = catchAsync(
...
const generateRandomAddress = catchAsync(
  async (req: Request, res: Response) => {
...
// Decimal To Octal
const convertDecimalToOctal = catchAsync(
  async (req: Request, res: Response) => {
...
// Octal To Decimal
const convertOctalToDecimal = catchAsync(
  async (req: Request, res: Response) => {
...
// Decimal to ASCII
const convertDecimalToASCII = catchAsync(
  async (req: Request, res: Response) => {
...
const generateUpsideDownText = catchAsync(
  async (req: Request, res: Response) => {
