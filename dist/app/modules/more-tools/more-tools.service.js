...
const generateRandomAddress = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!countryData[country]) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Country not supported. Supported countries: " + Object.keys(countryData).join(", "));
    }
    try {
        ...
        const zipCode = faker_1.faker.number.int({ min: countryInfo.zipRange[0], max: countryInfo.zipRange[1] }).toString();
