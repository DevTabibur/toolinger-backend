...
exports.DomainToolsService = void 0;
const axios_1 = __importDefault(require("axios"));
const getDomainAge_1 = require("../../utils/getDomainAge");
 ...
 * }
 */
const checkDomainAuthority = (domains) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to check domain authority");
    }
});
//============================================================
// 2. Domain IP History
 ...
 *   }
 */
const getDomainIPHistory = (domain) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Get current IP address
        const addresses = yield promises_1.default.lookup(domain, { all: true });
        const currentIp = addresses.length > 0 ? addresses[0].address : null;
        // Get WHOIS data to try to extract previous IPs (if available)
        const whoisData = yield (0, whois_json_1.default)(domain);
        ...
        let ipHistory = [];
        if (currentIp) {
            const geo = geoip_lite_1.default.lookup(currentIp);
            ipHistory.push({
                ip: currentIp,
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to get domain IP history");
    }
});
/**
 * Example usage in Postman:
 ...
 * - YaBB Forum
 */
const searchBlogs = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to search blogs");
    }
});
// 6. Link Extractor
/**
 ...
 * }
 */
const extractLinks = (url) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to extract links");
    }
});
// 7. Domain Age Checker
const checkDomainAge = (domain) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const domainAge = yield (0, getDomainAge_1.getDomainAge)(domain);
        return domainAge;
    }
    catch (error) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to check domain age");
    }
});
// 8. Reverse IP Domains
const getReverseIPDomains = (ip) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to get reverse IP domains");
    }
});
/**
 ...
 * }
 */
const checkGoogleMalware = (url) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to check Google malware");
    }
});
// 10. Backlink Maker
const createBacklinks = (url) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const backlinks = [
            {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to create backlinks");
    }
});
// 11. Broken Links Checker
const checkBrokenLinks = (url) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // const response = await axios.get(url);
        // const $ = cheerio.load(response.data);
        // const links: string[] = [];
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to check broken links");
    }
});
// 12. Google Indexer
const checkGoogleIndex = (url) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const checkReverseWhois = (email) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to check reverse WHOIS");
    }
});
// 15. Alexa Rank Checker
const checkAlexaRank = (domain) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to check Alexa rank");
    }
});
/**
...
const getFacebookShares = (url) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { data } = yield axios_1.default.get(apiUrl, { timeout: 5000 });
...
const getPinterestShares = (url) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getStumbleUponShares = (url) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getRedditShares = (url) => __awaiter(void 0, void 0, void 0, function* () {
    try {
 ...
 */
const countSocialMediaShares = (urlsInput) => __awaiter(void 0, void 0, void 0, function* () {
    // Accept either an array directly or an object with a 'urls' property
    let urls = [];
    if (Array.isArray(urlsInput)) {
        urls = urlsInput;
    }
    else if (typeof urlsInput === "object" &&
        urlsInput !== null &&
        Array.isArray(urlsInput.urls)) {
        urls = urlsInput.urls;
    }
    if (!Array.isArray(urls) || urls.length === 0 || urls.length > 20) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Please provide 1-20 URLs in an array.");
    }
    const results = yield Promise.all(urls.map((url) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const [facebook, pinterest, stumbleupon, reddit] = yield Promise.all([
...
const checkGooglePR = (domain) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to check Google PR");
    }
});
exports.DomainToolsService = {
