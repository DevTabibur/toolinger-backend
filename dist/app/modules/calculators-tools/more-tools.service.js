...
exports.MoreToolsService = void 0;
 ...
 */
// QR Code Scanner
const scanQRCode = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { qrCodeData } = data;
    if (!qrCodeData) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "QR code data is required");
    }
    try {
        ...
        yield analytics_model_1.default.updateOne({}, { $inc: { totalQRScanner: 1 } }, { upsert: true });
        return result;
    }
    catch (error) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to scan QR code");
    }
});
/**
...
function numberToRoman(num) {
    ...
    let roman = "";
    for (const value of Object.keys(lookup)
        .map(Number)
        .sort((a, b) => b - a)) {
        while (num >= value) {
            roman += lookup[value];
...
const convertRomanNumeralsDate = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { date } = data;
    if (!date) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Date is required");
    }
    ...
    if (match) {
        ...
        if (match) {
            ...
            throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Date format must be DD-MM-YYYY or YYYY-MM-DD");
        }
    }
    try {
        ...
        yield analytics_model_1.default.updateOne({}, { $inc: { totalRomanDate: 1 } }, { upsert: true });
        return { romanDate };
    }
    catch (error) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to convert Roman numerals date");
    }
});
/**
 ...
 */
const translateBinary = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { input, inputType, outputType } = data;
    if (!input || !inputType || !outputType) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Input, inputType, and outputType are required");
    }
    // Helper functions
    const parseInput = (input, type) => {
        switch (type) {
            ...
            default:
                throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Invalid inputType");
        }
    };
    const formatOutput = (nums, type) => {
        switch (type) {
            case "binary":
            ...
            default:
                throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Invalid outputType");
        }
    };
    try {
        ...
        yield analytics_model_1.default.updateOne({}, { $inc: { totalBinaryTranslator: 1 } }, { upsert: true });
        return {
            input,
            inputType,
            outputType,
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to translate value: " + error.message);
    }
});
/**
...
const generateRandomAddress = (data) => __awaiter(void 0, void 0, void 0, function* () {
    let { country = "USA" } = data;
    country = country.toUpperCase();
    if (!countryData[country]) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Country not supported. Supported countries: " +
            Object.keys(countryData).join(", "));
    }
    try {
        ...
        const zipCode = faker_1.faker.number
            .int({ min: countryInfo.zipRange[0], max: countryInfo.zipRange[1] })
            .toString();
        ...
        const phone = `${countryInfo.phoneCode}-${faker_1.faker.phone.number()}`;
        yield analytics_model_1.default.updateOne({}, { $inc: { totalRandomAddress: 1 } }, { upsert: true });
        return {
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to generate random address");
    }
});
// Discount Calculator
...
// }
const calculateDiscount = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { originalPrice, discountPercentage } = data;
    if (!originalPrice || discountPercentage === undefined) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Original price and discount percentage are required");
    }
    try {
        ...
        yield analytics_model_1.default.updateOne({}, { $inc: { totalDiscountCalculator: 1 } }, { upsert: true });
        return result;
    }
    catch (error) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to calculate discount");
    }
});
// Binary To Hex
const convertBinaryToHex = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { binary } = data;
    if (!binary) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Binary number is required");
    }
    try {
        ...
        yield analytics_model_1.default.updateOne({}, { $inc: { totalBinaryToHex: 1 } }, { upsert: true });
        return result;
    }
    catch (error) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to convert binary to hex");
    }
});
// Decimal To Octal
const convertDecimalToOctal = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { decimal } = data;
    if (decimal === undefined) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Decimal number is required");
    }
    try {
        ...
        yield analytics_model_1.default.updateOne({}, { $inc: { totalDecimalToOctal: 1 } }, { upsert: true });
        return result;
    }
    catch (error) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to convert decimal to octal");
    }
});
// Octal To Decimal
const convertOctalToDecimal = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { octal } = data;
    if (!octal) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Octal number is required");
    }
    try {
        ...
        yield analytics_model_1.default.updateOne({}, { $inc: { totalOctalToDecimal: 1 } }, { upsert: true });
        return result;
    }
    catch (error) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to convert octal to decimal");
    }
});
// HEX To RGB
const convertHEXToRGB = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { hex } = data;
    if (!hex) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "HEX color is required");
    }
    try {
        ...
        yield analytics_model_1.default.updateOne({}, { $inc: { totalHEXToRGB: 1 } }, { upsert: true });
        return result;
    }
    catch (error) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to convert HEX to RGB");
    }
});
/**
 ...
 * }
 */
const calculateOctal = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { num1, num2, operation } = data;
    if (num1 === undefined || num2 === undefined || !operation) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Two numbers and operation are required");
    }
    try {
        let result;
        switch (operation) {
            ...
            case "divide":
                ...
                break;
            default:
                throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Invalid operation");
        }
        yield analytics_model_1.default.updateOne({}, { $inc: { totalOctalCalculator: 1 } }, { upsert: true });
        return { num1, num2, operation, result };
    }
    catch (error) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to calculate octal");
    }
});
 ...
 * }
 */
const calculatePercentage = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { value, total } = data;
    if (value === undefined || total === undefined) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Value and total are required");
    }
    try {
        ...
        yield analytics_model_1.default.updateOne({}, { $inc: { totalPercentageCalculator: 1 } }, { upsert: true });
        return result;
    }
    catch (error) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to calculate percentage");
    }
});
// Decimal to ASCII
const convertDecimalToASCII = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { decimal } = data;
    if (decimal === undefined) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Decimal number is required");
    }
    try {
        ...
        yield analytics_model_1.default.updateOne({}, { $inc: { totalDecimalToASCII: 1 } }, { upsert: true });
        return result;
    }
    catch (error) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to convert decimal to ASCII");
    }
});
// Text to HEX
const convertTextToHEX = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { text } = data;
    if (!text) {
    ...
    try {
        ...
        yield analytics_model_1.default.updateOne({}, { $inc: { totalTextToHEX: 1 } }, { upsert: true });
        return result;
    }
    catch (error) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to convert text to HEX");
    }
});
// Adsense Calculator
/**
 ...
 * }
 */
const calculateAdsense = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { pageViews, cpm, clickRate } = data;
    if (!pageViews || !cpm || clickRate === undefined) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Page views, CPM, and click rate are required");
    }
    try {
        ...
        yield analytics_model_1.default.updateOne({}, { $inc: { totalAdsenseCalculator: 1 } }, { upsert: true });
        return result;
    }
    catch (error) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to calculate Adsense");
    }
});
/**
 ...
 * }
 */
const calculatePaypalFee = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { amount, country = "US" } = data;
    if (!amount) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Amount is required");
    }
    try {
        const feeRate = country === "US" ? 0.029 : 0.039;
        const fixedFee = country === "US" ? 0.3 : 0.35;
        ...
        yield analytics_model_1.default.updateOne({}, { $inc: { totalPaypalFeeCalculator: 1 } }, { upsert: true });
        return result;
    }
    catch (error) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to calculate PayPal fee");
    }
});
/**
 ...
 * }
 */
const generateUpsideDownText = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { text } = data;
    if (!text) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Text is required");
    }
    try {
        ...
        const upsideDown = text
            .split("")
            .reverse()
            .map((char) => upsideDownMap[char] !== undefined ? upsideDownMap[char] : char)
            .join("");
        const result = {
            original: text,
            upsideDown: upsideDown,
        };
        yield analytics_model_1.default.updateOne({}, { $inc: { totalUpsideDownText: 1 } }, { upsert: true });
        return result;
    }
    catch (error) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to generate upside down text");
    }
});
/**
 ...
 * }
 */
const generatePassword = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { length = 8, stringLetters = false, capitalLetters = false, digits = false, specialChars = false, } = data;
    if (!stringLetters && !capitalLetters && !digits && !specialChars) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "At least one character type must be selected");
    }
    if (!length || typeof length !== "number" || length < 1 || length > 64) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Password length must be between 1 and 64");
    }
    ...
    if (specialChars)
        chars += special;
    if (!chars) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "No character set selected");
    }
    let password = "";
    for (let i = 0; i < length; i++) {
        password += chars.charAt(Math.floor(Math.random() * chars.length));
    }
    yield analytics_model_1.default.updateOne({}, { $inc: { totalPasswordGenerated: 1 } }, { upsert: true });
    return { password };
});
/**
 ...
 */
const generateReverseText = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    switch (mode) {
        ...
        case "reverseEachWord":
            ...
            break;
        default:
            throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Invalid mode");
    }
    yield analytics_model_1.default.updateOne({}, { $inc: { totalReverseTextGenerated: 1 } }, { upsert: true });
    return { result };
});
/**
...
const convertRomanNumeral = (data) => __awaiter(void 0, void 0, void 0, function* () {
    let input = "";
    let output = "";
    if (data.decimal !== undefined && data.roman !== undefined) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Provide only one of 'decimal' or 'roman'");
    }
    if (data.decimal !== undefined) {
        // Decimal to Roman
        const decimal = Number(data.decimal);
        if (isNaN(decimal) || decimal <= 0 || decimal >= 4000) {
            throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Decimal must be a number between 1 and 3999");
        }
        input = decimal.toString();
        output = decimalToRoman(decimal);
        if (!output) {
            throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Invalid decimal number for Roman numeral conversion");
        }
    }
        ...
        if (!roman.match(/^[MDCLXVI]+$/i)) {
            throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Invalid Roman numeral");
        }
        input = roman;
        const decimal = romanToDecimal(roman);
        if (isNaN(decimal) || decimal <= 0 || decimal >= 4000) {
            throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Invalid Roman numeral for decimal conversion");
        }
        output = decimal.toString();
    }
    else {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Provide either 'decimal' or 'roman'");
    }
 ...
 * }
 */
const calculateLTV = (data) => __awaiter(void 0, void 0, void 0, function* () {
    if (typeof data.purchasePrice !== "number" ||
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Invalid input: purchasePrice must be > 0 and depositAmount must be >= 0 and <= purchasePrice");
    }
 ...
 * }
 */
const calculateCPM = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const { calculate, cost, impressions, cpm } = data;
    if (!["cost", "impressions", "cpm"].includes(calculate)) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Invalid 'calculate' value. Must be 'cost', 'impressions', or 'cpm'.");
    }
    let calculated;
    if (calculate === "cost") {
        if (typeof impressions !== "number" ||
            ...
            impressions <= 0 ||
            cpm < 0) {
            throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Invalid input: impressions must be > 0 and cpm must be >= 0.");
        }
        ...
        if (typeof cost !== "number" ||
            ...
            cost < 0 ||
            cpm <= 0) {
            throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Invalid input: cost must be >= 0 and cpm must be > 0.");
        }
        ...
        if (typeof cost !== "number" ||
            ...
            cost < 0 ||
            impressions <= 0) {
            throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Invalid input: cost must be >= 0 and impressions must be > 0.");
        }
        calculated = (cost / impressions) * 1000;
    }
    // Round to 2 decimal places for currency/CPM, 0 for impressions
    let roundedCalculated;
...
const randomWordsData = {
    ...
    nouns: ["shirt", "table", "cat", "dog", "apple", "banana", "book", "pen"],
    adjectives: [
        "amazing",
        "incompetent",
        "messy",
...
const generateRandomWord = (payload) => {
    let { numberOfGenerations, type } = payload;
    if (!numberOfGenerations ||
        typeof numberOfGenerations !== "number" ||
        numberOfGenerations < 1) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Please provide a valid number of generations.");
    }
    ...
    if (pool.length === 0) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "No words available for the selected type.");
    }
...
const calculateEPS = (payload) => {
    ...
    if (typeof netIncome !== "number" ||
        ...
        numberOfShares <= 0) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Please provide valid netIncome and numberOfShares (numberOfShares must be greater than 0).");
    }
 ...
 * }
 */
const calculateSalesTax = (payload) => {
    ...
    if (typeof salesTaxPercent !== "number" ||
        ...
        salesTaxPercent < 0 ||
        netPrice < 0) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Please provide valid salesTaxPercent (>= 0) and netPrice (>= 0).");
    }
 ...
 * }
 */
const calculateAverage = (payload) => {
    const { values } = payload;
    if (!Array.isArray(values) ||
        values.length === 0 ||
        values.some((v) => typeof v !== "number" || isNaN(v))) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Please provide an array of valid numbers in 'values'.");
    }
...
const wordsToPages = (payload) => {
    ...
    if (!wordsPerPageTable[fontFamily] ||
        !wordsPerPageTable[fontFamily][fontSize] ||
        !wordsPerPageTable[fontFamily][fontSize][spacing]) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Invalid fontFamily, fontSize, or spacing value.");
    }
    ...
    if (typeof words !== "number" || isNaN(words) || words < 0) {
        if (typeof text === "string") {
            ...
            throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Please provide a valid 'words' number or a 'text' string.");
        }
    }
    if (words === 0) {
...
const calculateValuation = (payload) => {
    ...
    if (typeof preMoney === "string")
        preMoney = Number(preMoney);
    if (typeof postMoney === "string")
        postMoney = Number(postMoney);
    if (typeof investment === "string")
        investment = Number(investment);
    // Count how many are provided
    const provided = [preMoney, postMoney, investment].filter((v) => typeof v === "number" && !isNaN(v));
    if (provided.length < 2) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Please provide at least two of: preMoney, postMoney, investment.");
    }
    ...
    else if (typeof postMoney === "number" &&
        !isNaN(postMoney) &&
        typeof investment === "number" &&
        !isNaN(investment)) {
        preMoney = postMoney - investment;
    }
    else if (typeof preMoney === "number" &&
        !isNaN(preMoney) &&
    ...
    if (typeof preMoney !== "number" ||
        ...
        isNaN(postMoney) ||
        isNaN(investment)) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Invalid input values for valuation calculation.");
    }
    return {
        preMoney: Number(preMoney),
        postMoney: Number(postMoney),
 ...
 * }
 */
const calculateBounds = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (typeof mean !== "number" ||
        ...
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Please provide valid values for mean, stdDev, sampleSize (>=2), and confidenceLevel.");
    }
 ...
 */
const calculateMargin = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (typeof cost !== "number" ||
        ...
        isNaN(sellingPrice) ||
        sellingPrice < 0) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Please provide valid values for cost and sellingPrice (both >= 0).");
    }
 ...
 */
const calculateAge = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    let { dob } = payload;
    if (!dob || typeof dob !== "string") {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Please provide a valid date of birth in 'YYYY-MM-DD' format.");
    }
    // Parse the date of birth
    const dobDate = new Date(dob);
    if (isNaN(dobDate.getTime())) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Invalid date of birth format. Use 'YYYY-MM-DD'.");
    }
    ...
    if (years < 0) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Date of birth cannot be in the future.");
    }
    return {
        years,
        months,
 ...
 */
const convertJPGToWord = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    // Placeholder implementation
    if (!payload.file) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "No JPG file provided.");
    }
 ...
 * @returns { wordFile: string } // base64 or file path
 */
const convertPDFToWord = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    // Placeholder implementation
    if (!payload.file) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "No PDF file provided.");
    }
 ...
 */
const convertTextToImage = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (!payload.text) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "No text provided.");
    }
 ...
 * @returns { text: string }
 */
const convertPDFToText = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (!payload.file) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "No PDF file provided.");
    }
 ...
 */
const calculateGST = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const { amount, gstRate } = payload;
    if (typeof amount !== "number" || typeof gstRate !== "number") {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Amount and GST rate must be numbers.");
    }
    if (amount < 0 || gstRate < 0) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Amount and GST rate must be non-negative.");
    }
 ...
 * }
 */
const calculateProbability = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    let { total, eventA, eventB } = payload;
    // Convert string inputs to numbers if necessary
    if (typeof total === "string")
        total = Number(total);
    if (typeof eventA === "string")
        eventA = Number(eventA);
    if (typeof eventB === "string")
        eventB = Number(eventB);
    // Validate inputs
    if (typeof total !== "number" ||
        isNaN(total) ||
        total <= 0 ||
        typeof eventA !== "number" ||
        isNaN(eventA) ||
        eventA < 0 ||
        eventA > total ||
        (eventB !== undefined &&
            (typeof eventB !== "number" ||
                isNaN(eventB) ||
                eventB < 0 ||
                eventB > total))) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Please provide valid values: total > 0, 0 <= eventA <= total, and (if provided) 0 <= eventB <= total.");
    }
    ...
    if (typeof eventB === "number" && !isNaN(eventB)) {
        ...
        result = Object.assign(Object.assign({}, result), { probabilityB: +probabilityB.toFixed(4), percentageB, probabilityAandB: +probabilityAandB.toFixed(4), percentageAandB });
    }
    return result;
});
//==========================================================================
// Helper functions
const convertToRoman = (date) => {
...
const convertFromRoman = (romanDate) => {
